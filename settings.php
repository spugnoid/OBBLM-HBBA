...
$db_name   = 'hbbaobbl_TESTING';
$db_user   = 'hbbaobbl_test';
$db_passwd = 'TESTmcselinux55';
$db_host   = 'localhost';
...
// Rule #4
$hrs[4]['rule']   = array('-pts', '-sdiff', '-tcdiff');    // Sort teams against: most points, then net TDs and then net CAS.
$hrs[4]['points'] = '6*[won] + 3*[draw] + 1*[lost]'; // The definition of points.

// Rule #5
$hrs[5]['rule']   = array('-pts', '-sdiff', '-tcdiff');    // Sort teams against: most points, then net TDs and then net CAS.
$hrs[5]['points'] = '3*[won] + 1*[draw] + 0*[lost]'; // The definition of points.

// Add you own rules here...
// Rule #6
$hrs[6]['rule']   = array('-pts', '-sdiff', '-tcdiff');    // Sort teams against: most points, then net TDs and then net CAS.
$hrs[6]['points'] = '3*[won] + 2*[draw] + 1*[lost]'; // The definition of points.

// Rule #7
$hrs[7]['rule']   = array('-sdiff', '-tcdiff'); // Sort teams against: largest score difference, then net CAS.
$hrs[7]['points'] = '';                      // Points not used.

// Rule #8 Deadliest Teams
$hrs[8]['rule']   = array('-cas', '-ki', '-si', '-bh', '-played'); // Sort teams against: net CAS.
$hrs[8]['points'] = '';                      // Points not used.